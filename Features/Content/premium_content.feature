Feature: Premium content
    ...
    Scenario: As a subscribed User, I get the full content
        ...
        Given I am on the "premium_article" page
         Then I see "Our objective is to provide you the most compelling" text
    ...
    Scenario: As a regular member, I get a teaser for Premium Content
        ...
        Given I am on the "premium_article" page
         Then I see "Key new features you don't want to miss" text
